class AppConstants {
  ...
  static const Duration eyeStrainReminder = Duration(minutes: 20); // 20-20-20 rule
  ...
  static const String storageErrorMessage = 'Unable to save data. Please check your storage permissions.';
