...
import 'package:flutter_riverpod/flutter_riverpod.dart'
    show Ref, ConsumerWidget, WidgetRef;
...
@riverpod
Future<List<TimeEntryWithProject>> recentTimeEntries(Ref ref) async {
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              height: 8,
              decoration: BoxDecoration(
                color: entryWithProject.project?.color ?? Colors.grey,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        entryWithProject.project?.name ?? 'Unknown Project',
