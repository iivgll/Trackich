...
import 'package:flutter_riverpod/flutter_riverpod.dart'
    show Ref, ConsumerWidget, StateProvider, WidgetRef;
...
class AnalyticsData {
  ...
  factory AnalyticsData.fromEntries(
  ...
  // Алгоритм Attention Residue для удаленных сотрудников
...
class ProjectAnalytics {
  ...
  factory ProjectAnalytics.fromEntries(
    Project project,
    List<TimeEntry> entries,
  ) {
